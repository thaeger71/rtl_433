...
static int tfa_303161_callback(r_device *decoder, bitbuffer_t *bitbuffer)
{
    data_t *data;
    int row;
    uint8_t *b;
  ...
  /* IIIICCII B???TTTT TTTTTSSS HHHHHHH1 XXXX */
    ...
    data = data_make(
            ...
            "raincounter",      "Rain counter 0.4l/m2 and count",    DATA_FORMAT, "%u", DATA_INT, rain_counter,
